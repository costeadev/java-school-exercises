...
//
//            paises[i] = new Pais(name, habitantes, superficie);
//
//            System.out.println();
//        }
        ...
        for (int i = 0; i < paises.length; i++) {
            System.out.printf("Densidad %s: %.2f habitantes/km2\n", paises[i].name(), paises[i].obtenerDensidad());
        }

//        System.out.print("name continente: ");
//        String name = scanner.nextLine();
//        Continente continente = new Continente(name, paises);
        Continente continente = new Continente("El mundo", paises);

        System.out.printf("\n--- DATOS DE %s ---\n", continente.getname().toUpperCase());
        System.out.printf("Superficie de %s: %.2f km2\n", continente.getname().toUpperCase(), continente.obtenerSuperficie());
        System.out.printf("Habitantes de %s: %d habitantes\n", continente.getname().toUpperCase(), continente.obtenerHabitantes());
