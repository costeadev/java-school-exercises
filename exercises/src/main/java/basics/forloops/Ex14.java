...
/*
 * Programa que lea de forma repetida un number N.
 * Para cada number leído:
...
public class Ex14 {
    public static void main(String[] args) {
        ...
        while (continuar) {
            ...
            int respuesta = Character.toLowerCase(scanner.next().charAt(0));
