...
public class Ex22 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < firstTrimesterGrades.length; i++) {
            double grade;
            do {
                System.out.printf("Que nota ha sacado el alumno %d en el primer trimestre?: ", i + 1);
        ...
        for (int i = 0; i < secondTrimesterGrades.length; i++) {
            double grade;
            do {
                System.out.printf("Que nota ha sacado el alumno %d en el segundo trimestre?: ", i + 1);
                grade = scanner.nextDouble();
            } while (grade < 0 || grade > 10);
        ...
        for (int i = 0; i < thirdTrimesterGrades.length; i++) {
            double grade;
            do {
                System.out.printf("Que nota ha sacado el alumno %d en el tercer trimestre?: ", i + 1);
                grade = scanner.nextDouble();
            } while (grade < 0 || grade > 10);
        ...
        int selectedStudent;
        do {
            System.out.print("De que alumno quieres ver la media? (1-5): ");
        ...
        System.out.printf("%nMedia alumno %d: %.2f", selectedStudent + 1, selectedStudentAverage);
    }
}
