...
public class Ex19 {
    public static void main(String[] args) {
        ...
        System.out.println("--- MOVER CARACTERES UN number DE SALTOS ---");
        ...
        if (scanner.hasNextInt()) {
            ...
            if (jumps > Integer.MAX_VALUE - 122) {
                System.err.printf("ERROR: El number es demasiado grande (máx permitido: %d", Integer.MAX_VALUE - 122);
                return;
            }
        ...
        // Input validation (Comprobamos que el number sea un char ASCII mínuscula y que no sea negativo
        if (jumps < 0) {
        ...
        int newChar1 = char1 + jumps; // Por ejemplo: la letra 'a' (97) + el number de saltos (10) = 107 (k) en ASCII
