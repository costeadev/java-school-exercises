...
// Pedir un number entre 0 y 99999 y mostrarlo con las cifras al revés.

public class Ex23V2 {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        System.out.println("--- MOSTRAR number CON CIFRAS AL REVES ---");
        ...
        switch (digitos) {
            case 5:
                esCapicua = (unidades == decenasMillar) && (decenas == millares);
                break;
            case 4:
                esCapicua = (unidades == millares) && (decenas == centenas);
                break;
            case 3:
        ...
        switch (digitos) {
            case 5 -> {
                System.out.printf("%d%d%d%d%d%n", unidades, decenas, centenas, millares, decenasMillar);
            }
            case 4 -> {
                System.out.printf("%d%d%d%d%n", unidades, decenas, centenas, millares);
            }
            case 3 -> {
                System.out.printf("%d%d%d%n", unidades, decenas, centenas);
            }
            case 2 -> {
                System.out.printf("%d%d%n", unidades, decenas);
            }
            case 1 -> {
                System.out.printf("%d%n", unidades);
            }
        }
