...
/*
 * Una compañía dedicada al alquiler de Cars cobra un monto fijo de 200 euros para los primeros 300 km de recorrido.
...
public class Ex9 {
    public static void main(String[] args) {
        ...
        System.out.println("--- CALCULAR TARIFA ALQUIER Car ---");

        System.out.print("Introduce la cantidad de kilómetros recorridos: ");
        int distancia = scanner.nextInt();

        if (distancia < 0) {
            System.err.println("Error: value negativo no válido");
            return;
        }
